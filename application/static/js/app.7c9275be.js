(function (e) {
    ...
    u.e = function (e) {
        ...
        if (0 !== c) if (c) t.push(c[2]); else {
            ...
            s = function (t) {
                ...
                if (0 !== n) {
                    if (n) {
                        var c = t && ("load" === t.type ? "missing" : t.type), r = t && t.target && t.target.src;
    ...
    0: function (e, t, n) {
        ...
        var c = [{id: 1, name: "test", api_token: "test", followers: [{id: 2}], following: [{id: 2}]}, {
            id: 2,
            name: "test2",
            api_token: "test2",
            followers: [{id: 1}],
            following: [{id: 1}]
        }], r = (c[0], c[1], c[0].username, c[0].password, [{name: "#GoLang", tweetsCount: 155614}, {
            name: "#Python",
            tweetsCount: 121353
        }, {name: "#DevConf2022", tweetsCount: 90420}])
    }, "0a8a": function (e, t, n) {
        "use strict";
        n.r(t);
        var c = n("7a23"), r = {xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", viewBox: "0 0 24 24"},
        ...
        var c = n("7a23"), r = {
                ...
                cy: "12",
                r: "1.5"
            }), Object(c["h"])("circle", {cx: "12", cy: "12", r: "1.5"}), Object(c["h"])("circle", {
                cx: "7",
                cy: "12",
                r: "1.5"
        ...
        var c = n("7a23"), r = {class: "add-tweet"}, i = {class: "add-tweet-profile"}, a = ["src"],
            o = {class: "add-tweet-content"}, u = {class: "tweet-section"}, s = {key: 0, class: "tweet-section-images"},
            l = ["src"], b = ["onClick"], d = {class: "controls"}, p = {class: "controls-media"},
        ...
        var m = n("5530"), O = n("3835"), j = n("1da1"),
            ...
            y = n("5502"), w = n("d4ec"), x = function e(t, n) {
                ...
                name: "AddTweet", components: {BaseIcon: v["a"]}, setup: function (e, t) {
                    ...
                    return {tweetContent: n, handleSubmit: u, hasTweetText: l, showFiles: b, deleteImage: d}
        ...
        function r(e, t, n, r, i, a) {
            var o = Object(c["C"])("DebugPanel"), u = Object(c["C"])("router-view"), s = Object(c["C"])("loading"),
        ...
        var i = n("5530"), a = (n("f5df1"), n("b0c0"), {class: "layout"}), o = {class: "layout-sidebar"},
            u = {class: "layout-flow"}, s = {class: "page-header"}, l = {key: 1, class: "profile-info"}, b = {key: 2},
            d = {class: "layout-for-you"}, p = {class: "layout-for-you-fixed"};

        function h(e, t, n, r, i, h) {
            var f = Object(c["C"])("sidebar"), g = Object(c["C"])("base-icon"), m = Object(c["C"])("SearchBar"),
                O = Object(c["C"])("Trends"), j = Object(c["C"])("tweet-popup"), v = Object(c["C"])("Lightbox"),
        ...
        var f = {class: "sidebar-nav"}, g = {class: "sidebar-logo"}, m = Object(c["j"])(" Профиль "),
            O = Object(c["j"])(" Еще "), j = {class: "icon"}, v = Object(c["h"])("span", null, "Close", -1);

        function y(e, t, n, r, i, a) {
            var o = Object(c["C"])("base-icon"), u = Object(c["C"])("router-link"), s = Object(c["C"])("sidebar-item"),
                l = Object(c["C"])("more-menu"), b = Object(c["C"])("profile-popup"), d = Object(c["C"])("BaseIcon");
        ...
        var w = {class: "sidebar-item"}, x = {class: "sidebar-item-logo"}, k = {class: "sidebar-item-content"};
        ...
        var q = z, L = [{name: "Home", path: "/", req: !0, label: "Главная"}, {
            ...
            T = {class: "sidebar-profile-items"}, A = {class: "profile-info"}, H = {class: "nickname"},
            R = {class: "more"}, V = {key: 0, class: "sidebar-profile-popup"}, _ = {class: "popup-header"},
        ...
        var X = n("5502"), Z = {
            name: "ProfilePopup", components: {BaseIcon: M["a"]}, data: function () {
                return {isMenuOpened: !1}
            }, computed: Object(i["a"])({}, Object(X["b"])({me: "getMe"})), methods: {
                toggleMenu: function () {
        ...
        n("417a");
        ve.render = pe;
        var ye = ve, we = {class: "searchbar-wrapper"}, xe = {class: "searchbar-icon"}, ke = {class: "searchbar-input"};
        ...
        n("1f92");
        Me.render = Ce;
        var ze = Me, qe = {ref: "popup", class: "tweet-popup-wrapper"}, Le = {class: "tweet-popup-header"};
        ...
        n("8b36");
        Pe.render = Se;
        var Be = Pe, Te = (n("99af"), {class: "lightbox-wrapper"}), Ae = {class: "lightbox-wrapper-item"}, He = ["src"],
            Re = {key: 0, class: "lightbox-controls"}, Ve = {key: 1, class: "lightbox-current-image"};
        ...
        var Fe = {
            name: "Lightbox", components: {BaseIcon: M["a"]}, props: {
                images: {
        ...
        var Ee = Fe, $e = {
            name: "Layout",
            components: {Sidebar: ue, TweetPopup: Be, BaseIcon: M["a"], Trends: ye, SearchBar: ze, Lightbox: Ee},
        ...
        var et = Ze, tt = {key: 0, class: "debug-panel"}, nt = {class: "debug-panel__current-key"},
            ...
            at = Object(c["h"])("label", null, "Пагинация", -1), ot = {key: 0, class: "debug-panel__pagination"},
        ...
        var c = n("1da1"), r = (n("99af"), n("96cf"), n("bc3a")), i = n.n(r), a = (n("94db"), n("4360"));
        n("0377");
        ...
        function l() {
            return l = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "get", path: "/api/users/".concat(t)}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        function v() {
            return v = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "post", path: "/api/tweets", body: t}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        function w() {
            return w = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "delete", path: "/api/tweets/".concat(t)}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        function q() {
            return q = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "post", path: "/api/medias", body: t}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        function S() {
            return S = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "post", path: "/api/tweets/".concat(t, "/likes")}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        function P() {
            return P = Object(c["a"])(regeneratorRuntime.mark((function e(t) {
                return regeneratorRuntime.wrap((function (e) {
                    while (1) switch (e.prev = e.next) {
                        case 0:
                            return e.abrupt("return", B({type: "delete", path: "/api/tweets/".concat(t, "/likes")}));
                        case 1:
                        case "end":
                            return e.stop()
                    }
        ...
        var c = n("7a23"), r = {
            ...
            cy: "12",
            r: "2"
        }), Object(c["h"])("circle", {cx: "12", cy: "12", r: "2"}), Object(c["h"])("circle", {
            cx: "19",
            cy: "12",
            r: "2"
        })], -1), a = [i];
        ...
        "use strict";
        n.r(t);
        var c = n("7a23"), r = {viewBox: "0 0 75 40"}, i = Object(c["h"])("rect", {width: "75", height: "6"}, null, -1),
            a = Object(c["h"])("rect", {y: "20", width: "75", height: "6"}, null, -1),
            o = Object(c["h"])("rect", {y: "40", width: "75", height: "6"}, null, -1), u = [i, a, o];
